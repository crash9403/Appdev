    ...
    <div class="col-lg-4 col-md-9 col-sm-6 col-xs-12">
        <div class="form-group">
            ...
            <select name="personas_id" id="personas_id" class="form-control selectpicker" data-livesearch="true" required>
                <option value="{{$asignaciond->personas_id}}" 
                selected>{{$asignaciond->personas->nombre}} {{$asignaciond->personas->apellido}}</option>
    ...
    <div class="col-lg-4 col-md-9 col-sm-6 col-xs-12">
        <div class="form-group">
            ...
            <select name="asignaturas_id" id="asignaturas_id" class="form-control selectpicker" data-livesearch="true" required>
                <option value="{{$asignaciond->asignaturas_id}}" 
                selected>{{$asignaciond->asignaturas->codigo_asignatura }} - {{$asignaciond->asignaturas->nombre_asignatura }}</option>
    ...
    <div class="col-lg-4 col-md-9 col-sm-6 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="ano_lectivo" id="ano_lectivo" class="form-control"
                value="{{$asignaciond->ano_lectivo}}" placeholder="Año lectivo">
        </div>
    </div>
